...
public class SampleTankDrive extends TankDrive {
    ...
    public SampleTankDrive(HardwareMap hardwareMap) {
        ...
        DcMotorEx mFL = hardwareMap.get(DcMotorEx.class, "mFL");
        DcMotorEx mBL = hardwareMap.get(DcMotorEx.class, "mBL");
        DcMotorEx mBR = hardwareMap.get(DcMotorEx.class, "mBR");
        DcMotorEx mFR = hardwareMap.get(DcMotorEx.class, "mFR");

        motors = Arrays.asList(mFL, mBL, mBR, mFR);
        leftMotors = Arrays.asList(mFL, mBL);
        rightMotors = Arrays.asList(mFR, mBR);
