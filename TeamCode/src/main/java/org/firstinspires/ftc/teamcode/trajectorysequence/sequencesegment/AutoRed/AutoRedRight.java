...
@Config
@Autonomous(name = "AutoRedRight" , group = "Red Section")
public class AutoRedRight extends LinearOpMode {
    ...
    public static double CONE_DELIVERY_X = 36, CONE_DELIVERY_Y = -10, CONE_DELIVERY_ANGLE = 180;

    public static double POSE_CONE_INTAKEX = 63, POSE_CONE_INTAKEY = -21, POSE_CONE_ANGLE = 0;
    ...
    public static double gripOpenDelay = 0.45;
